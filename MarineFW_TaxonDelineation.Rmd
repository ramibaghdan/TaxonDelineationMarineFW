...
COI.alignments <- readRDS("Data/COIalignmentsMalaco.Rdata")
barcode_data_coil_filtered_sets <- readRDS("Data/barcode_data_coil_filtered_setMalaco.Rdata")
sample.check <- readRDS("Data/samplecheckMalaco.Rdata")
